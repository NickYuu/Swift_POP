...
class PhotoDocumentWindowController: NSWindowController, NSWindowDelegate {
    ...
    fileprivate var drawAccessoryViewController: NSTitlebarAccessoryViewController!
    fileprivate var effectsAccessoryViewController: EffectsAccessoryViewController!
