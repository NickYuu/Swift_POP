...
class SidebarViewController: NSViewController, PhotoControllerConsumer {
    ...
    fileprivate var searchContainerViewHeight: CGFloat = 0.0
    fileprivate var appearanceObservationToken: NSObjectProtocol?
    fileprivate weak var observingLayoutRectInWindow: NSWindow?
...
extension SidebarViewController: NSTableViewDelegate, NSTableViewDataSource {
    ...
    fileprivate func loadImage(for imageItem: ImageItem, preferredSize: NSSize, row: NSInteger) {
